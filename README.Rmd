...
knitr::opts_chunk$set(
  ...
  fig.width = 8, fig.height = 4, dpi = 200
)
...
A common tweak I make to plots is to remove unnecessary axes.
The `remove_axis()` function saves a few lines of code:

```{r example_remove_axis}
p <- penguins %>%
...
```{r example_set_geom_fonts, fig.height=3, fig.width=4, message=F}
library(glue)
p <- penguins %>%
