...
There are a couple utility functions for working with the `distill` package and my website https://tdunn.ca/.

`get_distill_source()` generates a URL linking to the source code of posts:
