...
I have plans to write a convenience function that will set the default `ggplot2` color and fill scales.
...
For some reason, the `ggplot2.discrete.color` option doesn't like scale functions.
It will, however, work with just a list of the colors:
...
```
It may have something to do with [issue #4149 of ggplot2](https://github.com/tidyverse/ggplot2/issues/4149).
