...
where it would say “No FontName. Skipping” for every font. It turns out
this has to do with the `Rttf2pt1` package, which can be fixed be
installing an older version. See [this GitHub
